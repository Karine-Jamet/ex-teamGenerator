$(document).ready(function() {
  ...
  var Hat = function() {
    var students = ["Karine", "Jousna", "Jeanne d'arc", "Sarah", "Juliette", "Nadege", "Yannic", "Yannick", "Jerome", "Florent", "KevinL", "KevinC", "Ahmed", "Flavien", "Abdel-malik", "Ryadh", "Marc", "Anthony", "Bruno", "Simon"];
